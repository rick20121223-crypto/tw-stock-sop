...
DEVIATION_THRESHOLD = {"週": 0.25, "日": 0.20, "60分": 0.10, "5分": 0.06}
...
STOCK_NAME_MAP = {
    ...
    # 2026-09-11 依使用者指示刪除11檔（精材/玉山金/全新/兆豐金/高技/
    # 禾伸堂/鴻勁/台光電/台虹/主動復華未來50/順達），控制在舒服的檔數。
    "長廣": ("7795", "TW"),
    "尖點": ("8021", "TW"),
    "駐龍": ("4572", "TW"),
    "奇鋐": ("3017", "TW"),
    ...
    "新唐": ("4919", "TW"),
    "友達": ("2409", "TW"),
    # 2026-09-17 依使用者指示移除天鈺/騰輝電子-KY/欣興；新增大量/聯茂/臻鼎/南電
    # （南亞科/環球晶/金像電/陽程/台燿/景碩已在清單中，不重複新增）
    "大量": ("3167", "TW"),
    "聯茂": ("6213", "TW"),
    "臻鼎": ("4958", "TW"),
    "南電": ("8046", "TW"),
